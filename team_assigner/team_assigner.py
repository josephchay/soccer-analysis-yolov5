...
class TeamAssigner:
    ...
    def get_player_color(self, frame, bbox):
        img = frame[int(bbox[1]):int(bbox[3]), int(bbox[0]):int(bbox[2])]  # y1:y2, x1:x2
    ...
    def get_player_team(self, frame, player_bbox, player_id):
        ...
        # Currently hardcoded team id for player ids 119 and 155, which is the goalkeeper of team 1
        if player_id == 119 or player_id == 155:
            team_id = 1
